...
function create(url, params) {
  return PromiseFactory(chrome.windows.create, browser.windows.create, _extends({ url }, params));
}
...
function update(windowId, params) {
  return PromiseFactory(chrome.windows.update, browser.windows.update, _extends({}, params));
}
